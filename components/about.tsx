...
export default function About() {
  ...
  return (
    <section className="flex flex-col font-RB ">
        <h1 className=" font-semibold pt-32 text-6xl">
            Hi there. 安安！
        </h1>

        <h2 className="font-normal pt-12 text-4xl">
            My name is Yosun Lu.
        </h2>

        <div className="flex flex-col">
            <h3 className={`pt-12 ${textstyle}}`}>
            ...
            <h3 className={`pt-6 ${textstyle}}`}>
                My core stack includes <span className="underline-green">Node.js, Express.js</span>, and React. I also have experience with a wide range of technologies, 
